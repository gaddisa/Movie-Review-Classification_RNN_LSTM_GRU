"""
#################################################################################
The following code contains the implementation of question 1 using GRU
...
def train_gru():
    ...
    tf.flags.DEFINE_integer("checkpoint_every", 199, "Save model after this many steps")
    ...
    print("Training Using GRU in Progress, wait until the iteration ends, Thanks")    
        ...
        with sess.as_default():
            ...
            for batch in batches:
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    plt.title('Receiver Operating Characteristic (GRU,test)')
                    ...
                    plt.title('Preciion Recall Curve for GRU')
                    plt.xlabel('Recall')
