...
def test_text_to_ids(text_to_ids):
    ...
    source_vocab_to_int, source_int_to_vocab = preprocess.create_lookup_tables(test_source_text)
    target_vocab_to_int, target_int_to_vocab = preprocess.create_lookup_tables(test_target_text)
